...
class Methods:
    ...
    def translate(self, text_file:str, lang:str, encoding:str):
    ...
    def run(self):
        ...
        try:
            if starting_prompt == '1':
                ...
                print(f'Your file: {self.translate(text_file=self.transcribe(link=link_prompt), lang=lang_prompt, encoding=encoding_prompt)}, has been created!')
